...
export default class Tilt extends Interface {
  ...
  buildInterface() {
    ...
    this.barX.setAttribute('fill', this.colors.light);
    this.barY.setAttribute('fill', this.colors.light);
    this.barZ.setAttribute('fill', this.colors.light);
