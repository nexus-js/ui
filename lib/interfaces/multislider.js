...
export default class Multislider extends Interface {
  constructor() {
    ...
    */
    this.values =
      this.settings.values.length > this._numberOfSliders
        ? this.settings.values.slice(0, this._numberOfSliders)
        : this.settings.values.concat(
            Array(this._numberOfSliders - this.settings.values.length).fill(0)
          );
