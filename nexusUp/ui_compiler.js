...
<body>                                                                                                \
	...
	<div style="margin:0;padding:2px 10px;background-color:#0cf">     \
		<div style="float:left;font-size:16pt">'+this.patcher.name+'</div>     \
		<div style="float:right;font-size:8pt;">Powered by<br>• NexusUI •</div>     \
