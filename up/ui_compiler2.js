...
function createUDPReceive(port)
{
	...
	var receiver = this.patcher.newdefault(50, 510, "udpreceive", port);
	var printer = this.patcher.newdefault(50, 540, "print", "incoming");
	this.patcher.connect(receiver, 0, printer, 0);
	var maker = this.patcher.newdefault(ourself.rect[0]+40,ourself.rect[1]-40,"message");
	maker.message("set testing testing 123");
